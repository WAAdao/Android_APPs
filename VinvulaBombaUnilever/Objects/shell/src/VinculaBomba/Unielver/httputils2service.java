...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("httputils2service"), "VinculaBomba.Unielver.httputils2service");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("VinculaBomba.Unielver.httputils2service");
...
public static VinculaBomba.Unielver.main _main = null;
public static VinculaBomba.Unielver.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"hc",httputils2service._hc,"Main",Debug.moduleToString(VinculaBomba.Unielver.main.class),"Service",httputils2service.mostCurrent._service,"Starter",Debug.moduleToString(VinculaBomba.Unielver.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}