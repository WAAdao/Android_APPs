...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("httputils2service"), "wrong.addition.httputils2service");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("wrong.addition.httputils2service");
...
public static wrong.addition.main _main = null;
public static wrong.addition.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"hc",httputils2service._hc,"Main",Debug.moduleToString(wrong.addition.main.class),"Service",httputils2service.mostCurrent._service,"Starter",Debug.moduleToString(wrong.addition.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}