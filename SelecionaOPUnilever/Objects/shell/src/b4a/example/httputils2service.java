...
public static b4a.example.autostart _autostart = null;
  public Object[] GetGlobals() {
		return new Object[] {"Autostart",Debug.moduleToString(b4a.example.autostart.class),"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.example.main.class),"Service",httputils2service.mostCurrent._service,"Starter",Debug.moduleToString(b4a.example.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}