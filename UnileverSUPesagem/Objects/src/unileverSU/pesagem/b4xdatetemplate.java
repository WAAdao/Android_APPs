...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "unileverSU.pesagem.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", unileverSU.pesagem.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public unileverSU.pesagem.b4xdialog _mdialog = null;
...
_mdialog = new unileverSU.pesagem.b4xdialog();
...
public ResumableSub_Show(unileverSU.pesagem.b4xdatetemplate parent,unileverSU.pesagem.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
unileverSU.pesagem.b4xdatetemplate parent;
