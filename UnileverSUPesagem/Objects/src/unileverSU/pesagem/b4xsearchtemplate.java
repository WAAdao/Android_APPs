...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "unileverSU.pesagem.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", unileverSU.pesagem.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("928180513","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(unileverSU.pesagem.b4xsearchtemplate parent,unileverSU.pesagem.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
unileverSU.pesagem.b4xsearchtemplate parent;
