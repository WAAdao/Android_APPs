...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "unileverSU.pesagem.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", unileverSU.pesagem.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(unileverSU.pesagem.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public unileverSU.pesagem.b4xformatter._b4xformatdata  _copyformatdata(unileverSU.pesagem.b4xformatter._b4xformatdata _data) throws Exception{
unileverSU.pesagem.b4xformatter._b4xformatdata _d = null;
...
_d = new unileverSU.pesagem.b4xformatter._b4xformatdata();
...
public unileverSU.pesagem.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
unileverSU.pesagem.b4xformatter._b4xformatdata _d = null;
...
unileverSU.pesagem.b4xformatter._b4xformatdata _data = null;
...
public unileverSU.pesagem.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (unileverSU.pesagem.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public unileverSU.pesagem.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
unileverSU.pesagem.b4xformatter._b4xformatdata _d = null;
...
_d = (unileverSU.pesagem.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public unileverSU.pesagem.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
