...
public class b4xtable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "unileverSU.pesagem.b4xtable");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", unileverSU.pesagem.b4xtable.class).invoke(this, new Object[] {null});
        else
...
public unileverSU.pesagem.b4xformatter _defaultformatter = null;
public unileverSU.pesagem.b4xformatter _defaultdataformatter = null;
...
public unileverSU.pesagem.b4xfloattextfield _searchfield = null;
...
public unileverSU.pesagem.b4xformatter Formatter;
public String SQLID;
public int Width;
...
Sortable = false;
Searchable = false;
Formatter = new unileverSU.pesagem.b4xformatter();
SQLID = "";
Width = 0;
ComputedWidth = 0;
...
public unileverSU.pesagem.b4xtable._b4xtablecolumn  _addcolumn(String _title,int _columntype) throws Exception{
unileverSU.pesagem.b4xtable._b4xtablecolumn _c = null;
...
_c = new unileverSU.pesagem.b4xtable._b4xtablecolumn();
...
_c.Formatter /*unileverSU.pesagem.b4xformatter*/  = _defaultdataformatter;
...
public String  _addcolumntoclv(unileverSU.pesagem.b4xtable._b4xtablecolumn _c) throws Exception{
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group1.Get(index1));
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group5.Get(index5));
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group19.Get(index19));
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group3.Get(index3));
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group11.Get(index11));
...
public ResumableSub_CellClicked(unileverSU.pesagem.b4xtable parent,anywheresoftware.b4a.objects.B4XViewWrapper _pnl,boolean _longclicked) {
this.parent = parent;
this._pnl = _pnl;
this._longclicked = _longclicked;
}
unileverSU.pesagem.b4xtable parent;
anywheresoftware.b4a.objects.B4XViewWrapper _pnl;
boolean _longclicked;
unileverSU.pesagem.b4xtable._b4xtablecolumn _column = null;
int _row = 0;
String _e = "";
long _rowid = 0L;
int _clr = 0;
...
_column = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(_pnl.getParent().getTag());
...
public String  _checkandremovecolumnthatwasaddedtoincorrectparent(unileverSU.pesagem.b4xtable._b4xtablecolumn _c,boolean _isfrozen) throws Exception{
...
_defaultformatter = new unileverSU.pesagem.b4xformatter();
_defaultdataformatter = new unileverSU.pesagem.b4xformatter();
...
_searchfield = new unileverSU.pesagem.b4xfloattextfield();
...
public ResumableSub_Clear(unileverSU.pesagem.b4xtable parent) {
this.parent = parent;
}
unileverSU.pesagem.b4xtable parent;
...
if (index4 < groupLen4) {
this.state = 3;
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group4.Get(index4));}
if (true) break;
...
parent.__c.LogImpl("96750229","closing old db.",0);
...
public String  _columntosqltype(unileverSU.pesagem.b4xtable._b4xtablecolumn _c) throws Exception{
...
public String  _createcolumnlayouts(unileverSU.pesagem.b4xtable._b4xtablecolumn _c,int _size) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
;
for (; index5 < groupLen5;index5++){
_column = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group5.Get(index5));
...
public ResumableSub_DesignerCreateView(unileverSU.pesagem.b4xtable parent,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) {
this.parent = parent;
this._base = _base;
this._lbl = _lbl;
this._props = _props;
...
public unileverSU.pesagem.b4xtable._b4xtablecolumn  _getcolumn(String _columnid) throws Exception{
unileverSU.pesagem.b4xtable._b4xtablecolumn _c = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabelfromcolumn(unileverSU.pesagem.b4xtable._b4xtablecolumn _c,int _index) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public String  _headerclicked(unileverSU.pesagem.b4xtable._b4xtablecolumn _col) throws Exception{
unileverSU.pesagem.b4xtable._b4xtablecolumn _c = null;
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group2.Get(index2));
...
public ResumableSub_ImplUpdateDataFromQuery(unileverSU.pesagem.b4xtable parent,String _query,Object _args,int _totalcount,boolean _dontsleep) {
this.parent = parent;
this._query = _query;
this._args = _args;
...
this.state = 22;
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group17.Get(index17));}
if (true) break;
...
_c.Formatter /*unileverSU.pesagem.b4xformatter*/ ._formatlabel /*String*/ (_rs.GetDouble(_c.SQLID /*String*/ ),_lbl);
 if (true) break;
...
this.state = 38;
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group33.Get(index33));}
if (true) break;
...
parent.__c.LogImpl("97733318",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
;
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group24.Get(index24));
...
_c = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(_visiblecolumns.Get(_i));
...
public String  _removecolumnfromclv(unileverSU.pesagem.b4xtable._b4xtablecolumn _c) throws Exception{
int _i = 0;
...
if ((_c).equals((unileverSU.pesagem.b4xtable._b4xtablecolumn)(_clvdata._getvalue(_clvindex))) == false) { 
...
public String  _resizecolumnimpl(unileverSU.pesagem.b4xtable._b4xtablecolumn _c,int _totalheight) throws Exception{
float _height = 0f;
int _topint = 0;
int _heightint = 0;
int _i = 0;
...
public ResumableSub_SearchField_TextChanged(unileverSU.pesagem.b4xtable parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
public ResumableSub_SetData(unileverSU.pesagem.b4xtable parent,anywheresoftware.b4a.objects.collections.List _data) {
this.parent = parent;
this._data = _data;
}
unileverSU.pesagem.b4xtable parent;
...
if (index7 < groupLen7) {
this.state = 9;
_column = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group7.Get(index7));}
if (true) break;
...
unileverSU.pesagem.b4xtable._b4xtablecolumn _col = null;
...
;
for (; index1 < groupLen1;index1++){
_col = (unileverSU.pesagem.b4xtable._b4xtablecolumn)(group1.Get(index1));
