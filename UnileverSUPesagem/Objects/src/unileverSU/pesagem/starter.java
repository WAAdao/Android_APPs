...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "unileverSU.pesagem", "unileverSU.pesagem.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "unileverSU.pesagem.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Service.StopAutomaticForeground";
