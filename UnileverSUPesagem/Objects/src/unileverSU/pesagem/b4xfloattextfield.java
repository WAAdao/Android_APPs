...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "unileverSU.pesagem.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", unileverSU.pesagem.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public unileverSU.pesagem.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new unileverSU.pesagem.b4xfloattextfield();
...
__c.LogImpl("920054040","Multiline not supported with password mode.",0);
 };
...
public unileverSU.pesagem.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((unileverSU.pesagem.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(unileverSU.pesagem.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((unileverSU.pesagem.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (unileverSU.pesagem.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(unileverSU.pesagem.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
unileverSU.pesagem.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((unileverSU.pesagem.b4xfloattextfield)(this)) == false) { 
